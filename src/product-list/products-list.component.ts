...
export class ProductsListComponent implements OnInit {
    ...
    filteredProducts = computed(() => {
        ...
        return this.products().filter((product) => product.category === this.sharedState.selectedCategory());
    });
    ...
    constructor() {
        effect(() => {
            console.log('Filtered products have been updated:', this.filteredProducts());
        });
    }
